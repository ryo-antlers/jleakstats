    ...
    <div style={{ maxWidth: 760, margin: '0 auto', paddingBottom: 80, paddingTop: isSetup ? 24 : 0 }}>
      ...
      <Section label="Getting Started" title="監督就任までの流れ">
        ...
        <Step n="2" title="初期スカッドを15-20人で編成する">
          初期予算12億円でJ1リーグの選手を15-20人獲得します。ポジション構成と予算配分が最初の重要な決断です。
        </Step>
      ...
      <Section label="Squad Building" title="スカッド編成">
        ...
        <Table
          ...
          rows={[
            ...
            ['DF ディフェンダー', '4-6人', '3人', 'クリーンシート・守備アクション・キーパスが鍵'],
      ...
      <Section label="Points System" title="ポイント計算">
        ...
        <Table
          ...
          rows={[
            ...
            ['キーパス / 2本以上', '—', pt(1), pt(1), pt(1)],
            ['キーパス / 4本以上', '—', pt(2), pt(2), pt(2)],
            ['キーパス / 6本以上', '—', pt(3), pt(3), pt(3)],
          ]}
        />
